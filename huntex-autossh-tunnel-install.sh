...
# FIX: systemd روی بعضی سرورها ${LOGFILE} رو اینجا قبول نمی‌کنه → باید مسیر absolute باشد
StandardOutput=append:/var/log/huntex-autossh-tunnel.log
StandardError=append:/var/log/huntex-autossh-tunnel.log
